...
{
    /// <summary>
    /// Represents a command or action that a <see cref="Bot"/> can execute with given parameters from the user.
    /// </summary>
    public interface IBotCommand
    {
        /// <summary>
        /// An array of <see cref="BotParameterRequest"/> containing information about the required <see cref="IBotCommand"/> parameters.
        /// </summary>
        BotParameterRequest[] Parameters { get; }
        ...
        /// <param name="commandParameters">A <see cref="BotParameters"/> collection with the required command values.</param>
        Task ExecuteAsync(Bot bot, BotChat context, BotParameters commandParameters);
    }
}